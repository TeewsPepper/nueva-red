...
export const DashboardHeader: React.FC<DashboardHeaderProps> = ({
  ...
  const dropdownLinks = [
    ...
    { path: "/feed", icon: MessageSquare, label: "Muro" },
    { path: "/prayers", icon: Heart, label: "Oraciones" },
    { path: "/profile", icon: UserCircle, label: "Perfil" },
  ];

  const adminLinks = [
    { path: "/ministerios", icon: Church, label: "Ministerios" },
                ...
                <div className="dropdown-menu">
                  ...
                  {isAdmin && (
                    <>
                      <div className="dropdown-divider"></div>
                      <div className="dropdown-nav-section">
                        <div className="dropdown-nav-label">Administración</div>
                        {adminLinks.map((link) => (
                          <Link
                            key={link.path}
                            to={link.path}
